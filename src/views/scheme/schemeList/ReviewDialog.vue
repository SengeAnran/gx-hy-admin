<template>
  ...
  >
    ...
    <span slot="footer" class="dialog-footer">
      <el-button size="mini" type="" @click="closeView">关闭</el-button>
      <el-button size="mini" type="primary" @click="upReview">确定</el-button>
    </span>
  </el-dialog>
</template>

<script>
import {getComment, review} from "@/api/schemeList";
