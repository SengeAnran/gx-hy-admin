...
<!--      <el-link @click="showDetail(scope.data)" type="primary">编辑</el-link>-->
...
<!--      </el-dropdown>-->
    ...
    <template v-slot:form>
      <el-form-item label="名称" :rules="rule.input" prop="name">
        <el-input  placeholder="请输入名称"  v-model="form.name"></el-input>
      </el-form-item>
      <el-form-item label="井号" :rules="rule.input" prop="number">
        <el-input  placeholder="请输入名称"  v-model="form.number"></el-input>
      </el-form-item>
...
export default {
  ...
  methods: {
    ...
    toEditPage(query) {
      this.$router.push({
        path: '/scheme/chartEdit',
        query,
      })
    },
    toDetailPage(id) {
      this.$router.push({
        path: '/scheme/followDetail',
        query: {
          id,
        }
      })
