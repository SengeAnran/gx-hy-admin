  ...
  "cells": [
    {
      ...
      "id": "6e19989b-9a80-4af4-916d-eb5b58dbf8b6",
      "connector": "normal",
      "router": {
        "name": ""
      },
      ...
      "source": {
        "cell": "638b9304-5c47-4160-9a03-a9c553cd7065",
        "port": "port2"
      },
      "target": {
    ...
    },
    {
      ...
      "shape": "rect",
      "id": "638b9304-5c47-4160-9a03-a9c553cd7065",
      "ports": {
        "groups": {
          "top": {
            "position": "top",
    ...
    initX6(){
      ...
      this.graph = new Graph({
        ...
        interacting: {
          ...
          vertexMovable: false,   // 禁止调整连线锚点
          vertexAddable: false,   // 禁止添加边的路径点。
          useEdgeTools: false,    // 禁用边的编辑工具
        },
